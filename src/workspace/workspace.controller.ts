import { Controller, Post, Body, Param, UseGuards, Get, Patch, Delete, UseInterceptors, UploadedFile, BadRequestException } from '@nestjs/common';
...
export class WorkspaceController {
  ...
  updateName(@Param('id') id: string, @Body() dto: UpdateWorkspaceNameDto, @CurrentUser() user: User) {
  ...
  updateVisibility(@Param('id') id: string, @Body() dto: UpdateWorkspaceVisibilityDto, @CurrentUser() user: User) {
